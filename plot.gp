...
set ytics 0.005
set grid
plot "plot.data.part-3" using 7:($7-$5) title "run3" with lines lc rgb "red", \
     "plot.data.part-4" using 7:($7-$5) title "run4" with lines lc rgb "red", \
     "plot.data.part-5" using 7:($7-$5) title "run1-2" with lines lc rgb "red", \
     "plot.data.part-6" using 7:($7-$5) title "run2-2" with lines lc rgb "red", \
     "plot.data.part-7" using 7:($7-$5) title "run3-2" with lines lc rgb "red", \
     "plot.data.part-8" using 7:($7-$5) title "run4-2" with lines lc rgb "red", \
     "plot.data.part-9" using 7:($7-$5) title "run4-2" with lines lc rgb "red", \
     "plot.data.part-10" using 7:($7-$5) title "run5-2" with lines lc rgb "red", \
\
     "plot.data.part-3" using 7:($7-$11) title "run3" with lines lc rgb "blue", \
     "plot.data.part-4" using 7:($7-$11) title "run4" with lines lc rgb "blue", \
     "plot.data.part-5" using 7:($7-$11) title "run1-2" with lines lc rgb "blue", \
     "plot.data.part-6" using 7:($7-$11) title "run2-2" with lines lc rgb "blue", \
     "plot.data.part-7" using 7:($7-$11) title "run3-2" with lines lc rgb "blue", \
     "plot.data.part-8" using 7:($7-$11) title "run4-2" with lines lc rgb "blue", \
     "plot.data.part-9" using 7:($7-$11) title "run4-2" with lines lc rgb "blue", \
     "plot.data.part-10" using 7:($7-$11) title "run5-2" with lines lc rgb "blue" \
\
